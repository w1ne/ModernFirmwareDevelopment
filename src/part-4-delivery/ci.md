...
This prevents accidental deployment of "stale" builds or corrupted artifacts. A mismatch must stop the [Hardware-in-the-Loop](hil.md) verification or the [Continuous Delivery](cd-ota.md) pipeline immediately.
